...
class ResNetFeatureExtraction(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        # self.inplanesFusedExtraction = 512
        # self.bnExtraction = norm_layer(self.inplanesFusedExtraction)
        # self.lastLinear = nn.Linear(512, 8)
    ...
    def fused_output(self,firstEmb, secondEmb):
        ...
        # print("shape :", fused_emb.shape)

        # fused_emb = self.bnExtraction(fused_emb)
        fused_emb = rel(fused_emb)

        # print("fused emb shape : ", fused_emb.shape)

        fused_emb = torch.flatten(fused_emb, 1)

        # print("shape after flattering : ", fused_emb.shape)
